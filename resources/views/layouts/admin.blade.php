      ...
      <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav">
              <li>
                <a href="{{ route('token.index') }}" class="waves-effect"><i class="fa fa-cloud-upload m-r-10" aria-hidden="true"></i>Tokens</a>
              </li>
              <li>
                <a href="{{ route('users.index') }}" class="waves-effect"><i class="fa fa-cloud-upload m-r-10" aria-hidden="true"></i>Users</a>
              </li>
              <li>
                <a href="{{ route('function.index') }}" class="waves-effect"><i class="fa fa-cloud-upload m-r-10" aria-hidden="true"></i>Functions</a>
              </li>
              <li>
                <a href="{{ route('application.index') }}" class="waves-effect"><i class="fa fa-cloud-upload m-r-10" aria-hidden="true"></i>Applications</a>
              </li>
            </ul>              
          </nav>
